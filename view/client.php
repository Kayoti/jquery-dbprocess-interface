                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Users <small>Active Users List</small>
                        </h1>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>apples</td>
                                        <td>$321.33</td>
                                        <td><button data-toggle="modal" href="#form-content" id="view-btn" href="#" class="btn btn-lg btn-primary">view</button></td>
                                        <td><button id="deactivate-btn" href="#" class="btn btn-lg btn-danger">remove</button></td>
